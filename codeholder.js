...
export const images = () => {
    return src('src/images/**/*.{jpg,jpeg,png,svn,gif}')
...
export const dev = series(clean, parallel(styles, images, copy, scripts), serveSite, watchForChanges);
